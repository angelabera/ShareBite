...
handleFileSelect(file) {
    ...
    generateSampleListings() {
        const sampleListings = [
            ...
            {
                "id": 7,
                "foodType": "Bulk Dry Pasta",
                "quantity": "10 x 1kg bags",
                "category": "warehouse",
                "description": "Variety of dry pasta (spaghetti, penne) from a packaging mistake. Long shelf life.",
                "freshUntil": "this.getRandomFutureDate()",
                "pickupTime": "17:30",
                "location": "Food Distributor Warehouse, Industrial Park",
                "contact": "+1 234-567-8906",
                "createdAt": "new Date(Date.now() - 14400000)",
                "donor": "Food Distributor",
                "dietaryTags": ["vegan", "non-perishable"],
                "photoUrl": "https://skinnyspatula.com/wp-content/uploads/2022/10/Creamy_Garlic_Chicken_Pasta_0-735x735.jpg"
            },
            {
                "id": 8,
                "foodType": "Large Salad Bowls",
                "quantity": "5 bowls",
                "category": "restaurant",
                "description": "Mixed greens, cherry tomatoes, cucumbers, and balsamic dressing. Ingredients are all separate.",
                "freshUntil": "this.getRandomFutureDate()",
                "pickupTime": "17:00",
                "location": "Green Garden Restaurant",
                "contact": "+1 234-567-8903",
                ...
                "photoUrl": "https://avocadoskillet.com/wp-content/uploads/2024/07/IMG_2024-07-02-141855.jpeg"
            },
            {
                "id": 9,
                "foodType": "Canned Beans and Soup",
                "quantity": "50 cans (mixed)",
                "category": "grocery",
                "description": "Large donation of non-perishable canned goods, including black beans, kidney beans, and vegetable soup. Excellent for food banks.",
                "freshUntil": "this.getRandomFutureDate()",
                "pickupTime": "15:00",
                "location": "Local Supermarket, Shipping Dock",
                "contact": "+1 234-567-8908",
                "createdAt": "new Date(Date.now() - 28800000)",
                "donor": "Local Supermarket",
                "dietaryTags": ["vegan", "non-perishable", "gluten-free"],
                "photoUrl": "https://www.crowdedkitchen.com/wp-content/uploads/2020/10/3-bean-soup-3.jpg"
            }
